...
@section('content')
    <div id="table-url" data-url="/petugas"></div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            <div class="customers__area bg-style mb-30">
                <div class="item-title">
                    <div class="col-xs-6">
                        <a href="/petugas/create" class="btn btn-md btn-info">{{ __('Tambah Petugas')}}</a>
                    </div>
                </div>
    ...
    @push('post_scripts')
        <script src="{{asset('backend/js/admin/datatables/petugas.js')}}"></script>
    @endpush
@endsection